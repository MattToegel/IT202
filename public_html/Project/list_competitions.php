...
LEFT JOIN (SELECT * FROM RM_UserComps WHERE user_id = :uid) as uc ON uc.competition_id = RM_Competitions.id WHERE expires > current_timestamp() AND did_payout < 1 AND did_calc < 1 ORDER BY expires desc");
