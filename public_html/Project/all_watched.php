...
1 as is_watched,
(select count(user_id) FROM SC_UserGuides WHERE guide_id = SCG.id) as total_watched,
...
JOIN Users u on u.id = SCUG.user_id";
// the first space is important
$where = " WHERE 1=1"; //filter by user
