...
<ul>
    ...
    <li>The "Standard" Way that won't work: <a href="/M9/standard.php">here</a></li>
    <li>Using a third party image service (flickr, imgur, imgbb, etc): <a href="/M9/imgbb.php">here</a></li>
    <li>Recommended: Using a storage service (AWS S3, GCE Storage, Firebase Storage, etc): <a href="/M9/firebase.html">here</a></li>
