            ...
            <?php if (has_role("Admin")) : ?>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?php echo getURL("add_product.php"); ?>">Add Product</a></li>
                    </ul>
                </li><?php endif; ?>
            <?php if (is_logged_in(false)) : ?>
                <li class="nav-item"><a class="nav-link" href="<?php echo getURL("profile.php"); ?>">Profile</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo getURL("game.php"); ?>">Game</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo getURL("shop.php"); ?>">Shop</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo getURL("checkout.php"); ?>">Checkout</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo getURL("create_competition.php"); ?>">Create Competition</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo getURL("list_competitions.php"); ?>">List Competitions</a></li>
