...
if (isset($id)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT Eggs.id,name,state,base_rate,mod_min,mod_max,next_stage_time, user_id, Users.username FROM F20_Eggs as Eggs JOIN Users on Eggs.user_id = Users.id where id = :id");
